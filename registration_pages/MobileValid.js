  ...
  handleOTP = (otp) => {
   ...
   mobilevalidate = (mobilenumber) => {
    ...
    if (mobilenumber == 0) {
      ...
      let url = global.champBaseURL + 'Account/GetAccountDetailsByMobileNumber';
        ...
        <View style={{flex: 1, flexDirection: 'column', backgroundColor: '#fff'}}>
          ...
          >
            ...
            <Image
                ...
                style={{
                  height: 40, width: 95, marginTop: 5, marginBottom: 5,
          ...
          <KeyboardAvoidingView behavior="padding">
            ...
            <View
                style={{flex: 1, flexDirection: 'row', width: '100%', justifyContent: 'center', alignItems: 'center'}}>
          ...
          <View style={{
            ...
            <View style={{flex: 0.1, paddingLeft: '5%'}}>
              <CheckBox
                  ...
                  isChecked={this.state.isChecked}
                  checkedImage={<Image source={require('../pages/assets/images/checked.png')}
                                       style={{width: 20, height: 20}}/>}
                  unCheckedImage={<Image source={require('../pages/assets/images/uncheck.png')}
                                         style={{width: 20, height: 20}}/>}
              />
            </View>
            <View style={{flex: 0.9}}>
