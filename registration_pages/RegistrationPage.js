                    ...
                    if (responseJson.success) {
                        ...
                        db.transaction(function (tx) {
                            ...
                            tx.executeSql(
                                ...
                                '  ) VALUES (?,?,?,?,?,?)',
                                [responseJson.data.account.acAccntID, responseJson.data.account.acfName, responseJson.data.account.aclName,
                                responseJson.data.account.acMobile, responseJson.data.account.acEmail, responseJson.data.account.acisdCode],
                                (tx, results) => {
                                    console.log('INSERT Account ', results.rowsAffected + ' ' + association_id);
            ...
            <View style={styles.container}>
                <ScrollView>
                    <View style={{ flexDirection: 'column' }}>
                        ...
                        <Text style={{ fontSize: 13, color: 'black', margin: 10, justifyContent: 'center', alignSelf: 'center', alignContent: 'center' }}>
                            {global.MyISDCode} {global.MyMobileNumber}    </Text>
                        <View style={styles.input1}>
                        ...
                        <TouchableOpacity style={styles.rectangle}
                            onPress={this.AddMember.bind(this, this.state.FirstName, this.state.LastName,
                                this.state.Mail)}  >
                            <Text style={{ fontSize: 16, padding: 3, alignSelf: 'center', color: '#ed8a19',}}>
                                Register </Text>
                        </TouchableOpacity>
                        ...
                        <View style={{
                            ...
                            margin: 15, alignContent: 'center',
                        }}
                        >
                            <Text style={{ marginTop: 20, fontSize: 16, padding: 3, alignSelf: 'center', }}>
                                JABM Property Managers Pvt Ltd </Text>
                        </View>
                        <View style={{
                            backgroundColor: 'white', padding: 5, width: '100%', flexDirection: 'row-reverse',
                            margin: 5, alignContent: 'flex-end',
                        }}
                        >
                            <TouchableOpacity
                                style={{
                                    flexDirection: 'row-reverse', alignItems: 'center', width: 70,
                                    marginRight: 15,
                                }}
                                onPress={this.exitApp.bind(this)}  /*Products is navigation name*/>
                                <Image source={require('../pages/assets/images/logout.png')}
                                    style={{ height: 25, width: 25, margin: 5, alignSelf: 'center' }} />
                                <Text style={{ fontSize: 12, paddingLeft: 5, color: 'black', alignSelf: 'center' }}>Exit</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </ScrollView>
...
const styles = StyleSheet.create({
    ...
    input1: {
        marginLeft: 10, marginRight: 10, marginTop: 10, height: 40, borderColor: '#F2F2F2',
        backgroundColor: '#F2F2F2', borderWidth: 1.5, borderRadius: 2, flexDirection: 'row',
    },
    rectangle: {
        backgroundColor: 'white', padding: 5, borderColor: 'orange', height: 40, marginTop: 20, marginRight: 40,
        marginLeft: 40, borderRadius: 2, borderWidth: 1, alignContent: 'center',
    },

    input: {
        marginLeft: 15, marginRight: 15, marginTop: 40, height: 40, borderColor: '#F2F2F2',
        backgroundColor: '#F2F2F2', borderWidth: 1.5, borderRadius: 2, flexDirection: 'row',
    },
    ...
    text1: { fontSize: 12,  color: 'black', justifyContent: 'center', width: '65%' },
