...
class EditProfileBkp extends Component {
    constructor(props) {
        super(props)
        this.state = {
            FirstName: "",
    ...
    render() {
        ...
        const {photo} = this.state.photo?this.state.photo:base.utils.strings.staffPlaceHolder;
        console.log('AGHGHGHGH',base.utils.strings.staffPlaceHolder,this.props.navigation.state.params,this.props.navigation.state.params.profileDataSourceImageName,this.state.isPhotoAvailable)
                                    ...
                                    >
                                        <View style={styles.containerView_ForProfilePicViewStyle}>
                                            <View style={styles.viewForProfilePicImageStyle}>
                                                {this.props.navigation.state.params
                                                    .profileDataSourceImageName !== "" && !this.state.isPhotoAvailable ?
                                                    <Image
