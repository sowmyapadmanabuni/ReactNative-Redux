...
import {createNotification, getNotifications, newNotifInstance, updateJoinedAssociation} from '../src/actions';
        ...
        return (
            ...
            <View style={{
                        ...
                        <View style={{flexDirection: 'row'}}>
                            ...
                            <View style={{flex: 4, color: '#000000', padding: 10, textAlign: 'center'}}>
                                <Text style={{
                                    ...
                                    padding: 10,
                                    textAlign: 'center'
                                }}>{salutation} {global.MyFirstName}</Text>
                            </View>
                    ...
                    <View style={[styles.rectangle, {flexDirection: 'column'}]}>
                        ...
                        <View style={{flexDirection: 'column', marginLeft: '2%',}}>
                            <View style={{flexDirection: 'column',}}>
                                <Text
                                    style={{marginLeft: 40}}>Occupied {this.state.units_occupied_count}/{this.state.units_tot_count}</Text>
                                <View style={{
                                    flexDirection: 'row',
                                    width: 200,
                                    marginTop: 5,
                        ...
                        <View>
                            <View>
                                <TouchableOpacity
                                    ...
                                    <Text style={{fontSize: 13, color: 'black', paddingBottom: 10}}>View Resident
                                        List</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                ...
                <View style={[styles.navItemStyle, {
                    ...
                    <Text style={{flex: 1, justifyContent: 'center', alignSelf: 'center', paddingLeft: '10%',}}
                          onPress={this.deleteUser.bind(this)}>Log Out</Text>
                </View>
            </View>
        );
    }
