 ...
 */}
                        <Picker
                            ...
                            onValueChange={(itemValue, itemIndex) => {
                                global.SelectedUnitID = itemValue
                            }}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity
                                ...
                                <Text style={{
                                    ...
                                    color: 'black',
                                    paddingBottom: 10
                                }}> View Guard List </Text>
                            </TouchableOpacity>
                        </View>
                    </View>

                    <Text>Guards
                        Attendance {this.state.guard_onduty_count}/{(this.state.guard_tot_count + this.state.guard_onduty_count)}</Text>
