    ...
    if (this.state.isLoading) {
      ...
      return (
        ...
        <Text style={styles.titleOfScreen}>View All Visitors</Text>
          <TextInput style={styles.textinput} placeholder="search by name...." round onChangeText={this.searchFilterFunction}
          />
          ...
          <View style={{flexDirection: 'row',backgroundColor:'#f4f4f4',height:hp("6%") , alignItems:'center',justifyContent:'space-evenly',marginTop:15 }}>
              <View style={{ alignItems:'center',justifyContent:'space-around', alignItems:'center'}}>
                <Text style={{ fontSize: hp('2.2%'), color: '#474749',}}>Visitors Count: <Text style={{color:'black', fontWeight:'bold'}}>{this.state.totalVisitors}</Text></Text>
              </View>
              <View style={{ alignItems:'center',justifyContent:'space-around', alignItems:'center'}}>
                <Text style={{ fontSize: hp('2.2%'), color: '#474749',}}>Entries: <Text style={{color:'black', fontWeight:'bold'}}>{this.state.dataSource.length}</Text></Text>
              </View>
          </View>
          ...
          {this.state.dataSource.length == 0 ?
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: 'white' }}   >
              <Text style={{ backgroundColor: 'white',alignItems: 'center', justifyContent: 'center',fontSize:hp('2%') }}>No entries for selected date</Text>
