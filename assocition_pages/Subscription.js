...
export default class Subscription extends Component {
    ...
    render() {
        ...
        var subscriptionYear = [
            {
                label: "1 Year (" + (this.state.amount * this.state.count * 12) + ")",
                value: (this.state.amount * this.state.count * 12)
            },
            {
                label: "2 Year (" + (this.state.amount * this.state.count * 24) + ")",
                value: (this.state.amount * this.state.count * 24)
            },
            {
                label: "3 Year (" + (this.state.amount * this.state.count * 36) + ")",
                value: (this.state.amount * this.state.count * 36)
            },
        ];
                    ...
                    <View style={{flexDirecton: 'column'}}>
                        ...
                        <View style={{flexDirection: 'column', marginTop: 5}}>
                            ...
                            <View style={{flexDirection: 'row', marginTop: 5}}>
                                <Text style={{flex: 5, fontSize: 15, color: 'black', marginLeft: 10}}>1
                                    Year(Rs {this.state.amount * this.state.count * 12}/-)</Text>
                                <SwitchExample
                            ...
                            <View style={{flexDirection: 'row', marginTop: 5}}>
                                <Text style={{flex: 5, fontSize: 15, color: 'black', marginLeft: 10}}>2
                                    Years(Rs {this.state.amount * this.state.count * 24}/-)</Text>
                                <SwitchExample
                                    toggleSwitch1={this.toggleSwitchLeaveAtGuard}
                                    switch1Value={this.state.switchStYear2}/>
                            </View>
                            <View style={{flexDirection: 'row', marginTop: 5}}>
                                <Text style={{flex: 5, fontSize: 15, color: 'black', marginLeft: 10}}>3
                                    Years(Rs {this.state.amount * this.state.count * 36}/-)</Text>
                                <SwitchExample
