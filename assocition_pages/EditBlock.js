...
class EditBlock extends Component {
  ...
  submit = () => {
    ...
    if (this.state.blockname == "" || this.state.blockname == undefined) {
      ...
      fetch(this.props.champBaseURL + "Block/BlockDetailsUpdate", {
        method: "POST",
        headers: {
    ...
    return (
      <View style={styles.container}>
        <View>
          ...
          >
            <TouchableOpacity
              onPress={() => navigate("CreateBlockScreen", { cat: "" })}
            ...
            <View style={styles.row}>
              <View style={styles.inputWrap}>
                <TextField
                  ...
                  onChangeText={this.handleblockname}
                />
              </View>
            </View>
            ...
            <View style={styles.row}>
              <View style={styles.inputWrap}>
                <TextField
                  ...
                  onChangeText={this.handlenofunits}
                />
              </View>
            </View>
