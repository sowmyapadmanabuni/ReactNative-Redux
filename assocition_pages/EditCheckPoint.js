      ...
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: 'row', marginBottom: 5, marginTop: 25 }}>
          ...
          <TouchableOpacity
            ...
            <Image source={require('../pages/assets/images/placeholder.png')} style={{ height: 30, width: 30, alignItems: "flex-end", }} />
          </TouchableOpacity>
        ...
        <View style={{ flexDirection: 'row', backgroundColor: 'orange', marginLeft: 100 }}>
         ...
         <View style ={{flexDirection:'row'}}>
    <TouchableOpacity
       style = {{  flex:1,backgroundColor: 'white',  borderColor: 'orange',
