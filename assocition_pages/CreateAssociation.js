...
import {Button, Card, Form, Input, Item, Label} from "native-base";
...
class App extends Component {
    ...
    createassocition = () => {
        fetch(`http://${this.props.oyeURL}/oyeliving/api/v1/association/create`, {
            ...
            .then(responseJson1 => {
                this.setState({
                    assocID: responseJson1.data.association.asAssnID
                });
                console.log("The Association Id: ", this.state.assocID)
            })
            .then(responseJson => {
                alert("Association Created Successfully");
                this.props.navigation.navigate('BlockDetailScreen', {
                    associd: this.state.assocID
                })
                // Alert.alert(
                //   "",
