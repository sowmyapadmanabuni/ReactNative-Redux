...
class EditUnit extends Component {
    ...
    createUnit = () => {
        ...
        const {
            CalType, UnitNumber, UnitType, UnitRate, OccupancyStatus, UnitDimention, selectblock, Unitofname,
                    ...
                    <View style={styles.textWrapper}>
                        ...
                        <ScrollView>
                            ...
                            <Card style={{height: hp("23%"), marginTop: hp('0')}}>
                                <View style={{flexDirection: 'column'}}>
                                    ...
                                    <View style={{height: hp('10%'), marginTop: hp('1%')}}>
                                        <Text style={styles.text1}>Unit ID./Flat No./Site No./Door No.<Text
                                            style={styles.imp}>*</Text></Text>
                                    ...
                                    <View style={{height: hp('10%'), marginTop: hp('3%')}}>
                                        <View style={{flex: 1, height: hp('10%')}}>
                                            <Text style={styles.text1}>Occupancy Status & Ownership Status<Text
                                                style={styles.imp}>*</Text></Text>
                                            <Dropdown
                            ...
                            || this.state.OccupancyStatus === 'Sold Owner Occupied Unit' || this.state.OccupancyStatus === "Sold Tenant Occupied Unit" || this.state.OccupancyStatus === "Sold Vacant Unit" ?
                                <View>
                                    ...
                                    <Card style={{height: hp('56%'), marginTop: hp('0')}}>
                                                ...
                                                <View style={{flexDirection: 'column'}}>
                                                    <View style={{height: hp('7%'), marginTop: hp('0%')}}>
                                                        <View style={{height: hp('10%')}}>
                                                            <Text style={styles.text1}>Unit Owner Occupied Date<Text
                                                                style={styles.imp}>*</Text></Text>
                                                            <TouchableOpacity onPress={this.onDOBPress.bind(this)}>
                                                                <View style={styles.datePickerBox}>
                                                                    <Text
                                                                        style={styles.datePickerText}>{this.state.Ocdate.toString()} </Text>
                                                                    <DatePickerDialog
                                                                        ref="dobDialog"
                                        ...
                                        <View style={{height: hp('10%'), marginTop: hp('1%')}}>
                                            <Text style={styles.text1}>Owner Email ID<Text
                                                style={styles.imp}>*</Text></Text>
                                            <Item style={styles.bankDetailLine}>
                                                <Input
                                                    style={styles.box}
                                            ...
                                            <View style={{height: hp('10%'), marginTop: ('1%')}}>
                                                <View style={{flexDirection: 'column'}}>
                                                    <View style={{height: hp('7%')}}>
                                                        <View style={{height: hp('10%')}}>
                                                            <Text style={styles.text1}>Unit Tenant Occupied Date<Text
                                                                style={styles.imp}>*</Text></Text>
                                                            <TouchableOpacity onPress={this.onDOBPress1.bind(this)}>
                                                                <View style={styles.datePickerBox}>
                                                                    <Text
                                                                        style={styles.datePickerText}>{this.state.Osdate.toString()} </Text>
                                                                    <DatePickerDialog
                                                                        ref="dobDialog1"
                            ...
                            <View style={{flexDirection: 'row'}}>
                                <View
                                    style={{alignSelf: "center", marginTop: hp('2%'), flex: 0.5, marginLeft: hp('3%')}}>
                                    <Button
