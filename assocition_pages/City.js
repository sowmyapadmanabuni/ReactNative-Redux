...
<ScrollView>
        <TouchableWithoutFeedback onPress={() => this.props.navigation.navigate('AssnListScreen')}>
          <View>
            ...
            <View style={{ flexDirection: 'column', backgroundColor: '#ccd' }}>
            ...
            <FlatList
              style={{ marginTop: hp('1.5%'), marginLeft: hp('1.5%'),marginBottom:hp('4%') }}
...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: 'column', width: Dimensions.get("window").width / 4, height: Dimensions.get("window").width / 3 - 30, borderTopWidth: 1, borderRightWidth: 1, borderColor: "orange", alignItems: 'center', justifyContent: 'center' },
  formSearch: {
    marginBottom: hp("1%")
  },
  inputItem: {
