...
const mystyles = StyleSheet.create({
    ...
    signin: {
        height: '14px', width: '48px', color: '#060606', fontFamily: Fonts.Tahoma,
        fontSize: 12, //fontweight: 700, lineheight: '14px',
    },

    rectangle2: {
        height: '35px', width: '320px', backgroundColor: '#FFF',
    ...
    mobilenumberverification: {
        height: '10%', width: '100%', marginTop: '5%', color: '#060606', textAlign: 'center',
    ...
    thereisnorecordofthisnum: {
        marginLeft: 25, marginRight: 25, color: '#f00', fontFamily: Fonts.Tahoma,
    ...
    rectangle1: {
        height: '31px', width: '210px', backgroundColor: '#FBA330',
        // boxshadow: 0 1px 4px 0 rgba(0,0,0,0.5),
    },

    getotp: {
        height: '12px', width: '50px', color: '#FFFEFE', fontFamily: Fonts.Tahoma,
    ...
    oval: {
        height: '29.05%', width: '50.94%',   // boxsizing: borderbox,  border: 15px solid #FA9917,
    },
