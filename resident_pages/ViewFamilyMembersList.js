...
export default class ViewFamilyMembersList extends Component {
    ...
    return (
      ...
      >
        ...
        <View style={{ flex: 1, justifyContent: "center", marginLeft: 5 }}>
          ...
          <Text style={{ fontSize: 16, color: "red" }}>{item.agenda}</Text>
        </View>
        <TouchableOpacity
          style={styles.mybutton1}
          onPress={() =>
            navigate("Unit", { id: item.associationID })
  ...
  renderSeparator = () => {
    return (
      <View style={{ height: 1, width: "100%", backgroundColor: "darkgrey" }} />
    );
  };
  ...
  refresh() {
    const url =
      ...
      "FamilyMember/GetFamilyMemberListByAssocID/" +
      global.SelectedAssociationID;
    ...
    fetch(url, {
      ...
      .then(responseJson => {
        ...
        this.setState({
          dataSource: responseJson.data.familyMembers.filter(
            x => x.meMemID === global.MyOYEMemberID
          ),
          isLoading: false
        });
      })
...
<View style={{ backgroundColor: 'lightgrey', flexDirection: "row", width: '100%', height: 1, }}></View> */}
                ...
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <View style={styles.rectangle}>
                      <View
                        style={{ flex: 3, flexDirection: "row", padding: 2 }}
                      >
                        <ImageLoad
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            navigate("EditFamilyMemberScreen", {
                              id: item.fmid
                            })
                          }
                        >
                  ...
                  keyExtractor={({ oyeFamilyMemberID }, index) =>
                    oyeFamilyMemberID
                  }
                  ListHeaderComponent={() =>
          ...
          <ActionButton
            buttonColor="#FA9917"
            onPress={() => navigate("AddFamilyMemberScreen", { cat: "" })}
          />
