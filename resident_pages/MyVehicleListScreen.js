...
class MyVehicleList extends Component {
  ...
  getVehicleList = () => {
    fetch(
      `http://${this.props.oyeURL}/oyeliving/api/v1/Vehicle/GetVehicleListByMemID/3`,
      {
        method: "GET",
        headers: {
            ...
            >
              {item.veType == "Two Wheeler" ? (
                <Image
                  ...
                  source={require("../icons/2wheeler.png")}
                />
              ) : (
                <Image
                  style={{ width: hp("5%"), height: hp("5%") }}
                  source={require("../icons/4wheeler.png")}
                />
              )}
            </View>
            <View
              ...
              <TouchableOpacity
                onPress={() => {
                  this.props.navigation.navigate("EditVehiclesScreen", {
                    VehName: item.veMakeMdl,
                    VehNum: item.veRegNo,
                    VehStickerNum: item.veStickNo,
                    VehParkingSlotNum: item.uplNum,
                    VehType: item.veType
                  });
                }}
              >
...
export default connect(mapStateToProps)(MyVehicleList);