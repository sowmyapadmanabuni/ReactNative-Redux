            ...
            <View style={styles.container}>
                ...
                <View>
                    <View>
                        ...
                        <Text style={{fontSize: 16, color: 'black', fontWeight: 'bold', margin: 10}}>Create
                            Worker</Text>
                ...
                <View style={{flex: 0.8, flexDirection: 'column',}}>
                    ...
                    <View style={{flexDirection: 'row'}}>
                        <View style={{flex: 0.3, marginTop: '3%'}}>
                            <Text style={{fontSize: 15, color: 'black', marginTop: 3, marginLeft: 10}}>Security
                                Guard: </Text>
                        </View>
                        <View style={{flex: 0.7}}>
                            <Picker
                    ...
                    <View style={{flexDirection: 'row'}}>
                        <View style={{flex: 0.3, marginTop: 10,}}>
                            <Text style={{fontSize: 15, color: 'black', marginTop: 3, marginLeft: 10}}>Work off
                                day: </Text>
                        </View>
                        <View style={{flex: .7}}>
                            <Picker
