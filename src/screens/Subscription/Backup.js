                    ...
                    <View style={{width:'90%',alignItems:'center',}}>
                        <View style={{width:'100%',height:'200%',alignItems:'center',}}>
                            <View style={{height:'6%',width:'100%',alignItems:'center',}}>
                                <Text style={{fontSize:14,color:base.theme.colors.black,marginTop:10}}>Choose Your Plan</Text>
                            </View>
                            <View style={{width:'100%',alignItems:'center',height:'100%',marginBottom:10,borderWidth:1}}>
                                <View style={{height:'100%',width:'95%',flexDirection:'column',
                                    alignItems:'flex-start'}}>
                                    <View style={{width:'100%', height:'3%',flexDirection:'row',alignItems:'flex-end',
                                        justifyContent:'space-around',backgroundColor:'red'}}>
                                        <Text style={{fontSize:12,color:base.theme.colors.primary,marginTop:'5%'}}>
                                            Existing Subscription -
                                        </Text>
                                        <Text style={{fontSize:12,color:base.theme.colors.black,marginTop:'5%'}}>
                                            Valid Till:
