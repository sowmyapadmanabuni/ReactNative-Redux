...
export const getDashUnits = (associationId, oyeURL) => {
  console.log("UNIT,OYEURL:",associationId,oyeURL);
  return dispatch => {
    let sold = 100;
    let unsold = 100;
    let totalunits1 = 0;
    ...
    axios
        .get(
            `http://${oyeURL}/oyeliving/api/v1/Member/GetMemUniOwnerTenantListByAssoc/${associationId}`,
            {
              headers: {
                "Content-Type": "application/json",
                "X-Champ-APIKey": "1FDF86AF-94D7-4EA9-8800-5FBCCFF8E5C1"
        ...
        .then(response => {
          ...
          fetch(
              `http://${oyeURL}/oyeliving/api/v1/Unit/GetUnitListByAssocID/${associationId  }`,
              {
                method: "GET",
                headers: {
                  "Content-Type": "application/json",
                ...
                if (responseJson.success) {
                  ...
                  for (var i = 0; i < count; i++) {
                    ...
                    for (var j = 0; j < count1; j++) {
                      console.log('RoleId:>', responseJson.data.unit[i])
                  ...
                  console.log("New Owner",newResidentOwner);
                  console.log("New Tenant",newResidentTenant);
                  ...
                  console.log("New Resident",newResidents);
