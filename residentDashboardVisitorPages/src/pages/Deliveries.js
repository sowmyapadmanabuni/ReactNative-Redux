        ...
        return (
            <View style={{flexDirection: "column", marginBottom: index === this.state.dataSource.length - 1 ? 80 : 0}}>
                ...
                <View style={{flexDirection: 'row'}}>
                    <View style={{flex: 1}}>
                        <Text style={{fontSize: hp('1.6%'), marginLeft: hp('1%'), marginTop: hp('1%')}}>Unit
                    ...
                    <View style={{}}>
                        <Text style={{
                            ...
                            marginRight: hp('1%'),
                            marginTop: hp('1%')
                        }}>{moment(item.vldCreated, "YYYY-MM-DD").format("DD-MM-YYYY")}</Text>
                    </View>
                </View>
                <View
                    style={[
                ...
                <Text style={styles.infoNumber}>{item.vlMobile}</Text>
                            ...
                            <View style={{flexDirection: 'row', marginBottom: hp('0.3%')}}>
                                ...
                                <View>
                                    <Text style={{fontSize: hp('1.5%')}}>Entry
                                        Time: {item.vlEntryT.substring(11, 16)}{" "}</Text>
                                </View>
                                {moment(item.vlExitT).format("hh:mm") === '00:00' ?
                                    ...
                                    <View style={{flexDirection: 'row'}}>
                                        <View>
                                            <Text style={{fontSize: hp('1.5%')}}>Exit
                                                Time: {item.vlExitT.substring(11, 16)}</Text>
                                        </View>
                                    </View>
                                }
                            </View>
